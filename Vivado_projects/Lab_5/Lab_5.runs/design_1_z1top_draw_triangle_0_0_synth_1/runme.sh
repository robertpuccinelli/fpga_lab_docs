...
HD_PWD='C:/Users/Robby/Desktop/Lab_5/Lab_5.runs/design_1_z1top_draw_triangle_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_z1top_draw_triangle_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_z1top_draw_triangle_0_0.tcl
