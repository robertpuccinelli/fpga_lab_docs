...
HD_PWD='C:/Users/Robby/Desktop/Lab_3/Lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z1top_calculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z1top_calculator.tcl
