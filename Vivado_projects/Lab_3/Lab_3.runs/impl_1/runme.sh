...
HD_PWD='C:/Users/Robby/Desktop/Lab_3/Lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log z1top_calculator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source z1top_calculator.tcl -notrace
